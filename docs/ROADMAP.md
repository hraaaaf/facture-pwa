...
> Source de vérité du projet. En cas de nouvelle fenêtre : `docs/HANDOVER.md` → ce fichier → `docs/E0_ONBOARDING.md` → `docs/UI_V1_MOBILE_SPEC.md` → `docs/mockups/MOCKUPS_LOCK.md`.
...
1. **LOT 2 — Clients & catalogue rapide**.
2. LOT 3 — fidélité PDF Original + remises.
3. LOT 4 — PDF Premium + remises + polish.
4. Audit 390 / 430 / 768, E0 à E6.
5. Gates runtime LOT1 + backup + offline + installation + partage.
