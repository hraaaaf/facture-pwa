...
try {
  ...
  assert.equal(object, 'Renouvellement linge hôtellerie')
  assert.deepEqual(designations, ['Drap blanc 240x300', 'Serviette bain 70x140', 'Nappe rectangulaire 180x300'])
  assert.deepEqual(units, ['Pièce', 'Unité', 'm'])
